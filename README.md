...
3. Enter: `https://github.com/Sm1-z/ai-dlc-workflow-power`
4. Click Install
...
- **Method Definition**: [AI-DLC Methodology Paper](https://arxiv.org/abs/2410.21880)
- **Original Repository**: [aidlc-workflows](https://github.com/aws-samples/aidlc-workflows)
- **Kiro Documentation**: [Kiro Powers](https://docs.kiro.ai/powers)

## Contributing

This Power implements the official AWS AI-DLC methodology. For methodology improvements, please refer to the [original AWS repository](https://github.com/aws-samples/aidlc-workflows). For Power-specific issues or improvements:
...
- **Kiro Support**: [Kiro Documentation](https://docs.kiro.ai)
- **AI-DLC Methodology**: [AWS AI-DLC Resources](https://github.com/aws-samples/aidlc-workflows)
